    ...
    return (
        <div className="flex h-screen bg-white">
            ...
            <>
                    ...
                    {/* Sidebar */}
                    <aside
                        className={`fixed lg:static inset-y-0 left-0 z-40 w-64 bg-white border-r border-gray-200 transform transition-transform duration-200 ease-in-out lg:transform-none overflow-y-auto scrollbar-hide ${
                        ...
                        <div className="h-full flex flex-col">
                                        ...
                                        >
                                            <item.icon
                                                className={`h-5 w-5 mr-3 ${
                                                    activeTab === item.id ? 'text-[#003971]' : 'text-gray-400'
                                                }`}
                                            />
                                            {item.label}
                                        </button>
                            ...
                            <div className="px-4 py-6">
                                ...
                                >
                                    <UserCircle
                                        className={`h-5 w-5 mr-3 ${
                                            activeTab === 'settings' ? 'text-[#003971]' : 'text-gray-400'
                                        }`}
                                    />
                                    Profile Settings
                                </button>
