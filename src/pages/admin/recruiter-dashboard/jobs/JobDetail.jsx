...
function JobDetail({ onBack }) {
    ...
    const confirmPublishToggle = () => {
        ...
        // Navigate to jobs dashboard after publishing
        navigate('/admin/jobs');
    };

    const handleEditJob = () => {
        navigate('/admin/upload-job', { state: { jobData: job, isEdit: true } });
    };
            ...
            <div className="flex items-start justify-between mb-6">
                ...
                <div className="flex items-center gap-3">
                    <button 
                        ...
                        className={`flex items-center gap-2 px-5 py-2.5 border rounded-lg font-semibold transition-colors ${
                            isPaused 
                                    ...
                                    <td className="px-6 py-4">
                                        <div>
                                            <div className={`font-semibold ${
                                                applicant.compliance === 'Ready' ? 'text-green-600' : 'text-orange-600'
                                            }`}>
