...
function DemandPlanning() {
  ...
  const periodQuery =
    rangeTab === "30 Days" ? "30d" : rangeTab === "60 Days" ? "60d" : "90d";
      ...
      try {
        ...
        setDashboardData({
          ...
          renewalDemand: Array.isArray(data.renewalDemand)
            ? data.renewalDemand
            : [],
          engagementCourses: Array.isArray(data.engagementCourses)
            ? data.engagementCourses
            : [],
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Professionals with expiries in the next 12 months. Top:{" "}
                {topTrendingCourse}
              </p>
            </div>
        ...
        <div className="xl:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex flex-col">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Projected expiries over the next 12 months (same filters as
                tables)
              </p>
            </div>
            ...
            <div className="mb-5">
              ...
              <div className="h-3 w-full bg-gray-100 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${capacityUtilization === null ? 0 : capacityUtilization}%`,
                  }}
                />
              </div>
            </div>
        ...
        <div className="xl:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex flex-col">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Counts are for the next 12 months (year / course / search
                filters apply). Use the period tabs for the summary subtitle
                above.
              </p>
            </div>
            <div className="bg-gray-50 p-1 rounded-xl inline-flex border border-gray-100">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 mt-0.5">
                          {courseItem.views} views • {courseItem.enquiries}{" "}
                          enquiries
                        </p>
                      ...
                      <span
                        className={`px-3 py-1 rounded-full text-[11px] font-semibold whitespace-nowrap ${
                          statusStyles[courseItem.statusVariant]
                        }`}
                      >
                        {courseItem.status}
                      </span>
