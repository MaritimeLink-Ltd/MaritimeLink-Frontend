...
const TrainingProviderProfile = () => {
    ...
    const handleDeleteAccount = async () => {
        try {
            ...
            await authService.deleteTrainerAccount();
                ...
                <div className="flex-1 overflow-y-auto space-y-6 pr-2">
                    ...
                    {activeTab === 'security' && (
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                            ...
                            <p className="text-sm text-gray-500 mb-6">Permanently delete your training provider account and all associated data.</p>
                            <button
                                type="button"
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-gray-600">This action cannot be undone. All your data, including your courses, bookings, and messages will be permanently deleted.</p>
                            </div>
