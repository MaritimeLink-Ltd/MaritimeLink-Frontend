                                ...
                                <div className="flex items-start gap-4 flex-1">
                                    ...
                                    <div className="flex-1">
                                        <h3 className="text-base font-bold text-gray-900 mb-2">
                                            Training Provider Platform Update v2.4
                                        </h3>
                                        <p className="text-sm text-gray-600 leading-relaxed">
                                            New features include automated session scheduling, certificate generation, and advanced demand
                                            forecasting for training courses.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 relative">
                            ...
                            <div className="pr-8">
                                <p className="text-sm text-gray-900 mb-6 leading-relaxed">
                                    You are about to <span className="font-bold">cancel training session</span> for{' '}
                                    <span className="font-bold text-gray-900">STCW Basic Safety Training</span>. All enrolled students will be notified.
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 relative">
                            ...
                            <div className="flex items-center gap-3 pr-8">
                                ...
                                <p className="text-sm text-gray-900">
                                    <span className="font-bold">Success!</span> Certificates generated for 24 students who completed "Advanced Fire Fighting" course. Email notifications sent.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 relative">
                            ...
                            <div className="flex items-center gap-3 pr-8">
                                ...
                                <p className="text-sm text-gray-900">
                                    <span className="font-bold">Demand Alert:</span> High demand detected for "ECDIS Training" in your region. Consider scheduling additional sessions.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 relative">
                            ...
                            <div className="flex items-center gap-3 pr-8">
                                ...
                                <p className="text-sm text-gray-900">
                                    <span className="font-bold">Low Enrollment:</span> Only 3 students enrolled in "Medical Care" session scheduled for next week. Minimum 8 students required.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 relative">
                            ...
                            <div className="flex items-center gap-3 pr-8">
                                ...
                                <p className="text-sm text-gray-900">
                                    <span className="font-bold">Error:</span> Failed to sync course data with certification authority. Please check your integration settings.
                                </p>
                            </div>
                        </div>
                    </div>
