...
import ProfessionalUserTermsContent, {
    PROFESSIONAL_USER_TERMS_TITLE,
} from '../../components/auth/ProfessionalUserTermsContent';

function PublicProfessionalUserTerms() {
    return (
...
export default PublicProfessionalUserTerms;
