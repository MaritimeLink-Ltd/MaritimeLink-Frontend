...
import RecruiterTermsContent, { RECRUITER_TERMS_TITLE } from '../../components/auth/RecruiterTermsContent';

function PublicRecruiterTerms() {
    return (
...
export default PublicRecruiterTerms;
