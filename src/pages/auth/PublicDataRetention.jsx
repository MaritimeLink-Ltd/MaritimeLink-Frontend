...
import DataRetentionContent, { DATA_RETENTION_TITLE } from '../../components/auth/DataRetentionContent';

function PublicDataRetention() {
    return (
...
export default PublicDataRetention;
