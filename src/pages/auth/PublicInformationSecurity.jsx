...
import InformationSecurityContent, {
    INFORMATION_SECURITY_TITLE,
} from '../../components/auth/InformationSecurityContent';

function PublicInformationSecurity() {
    return (
...
export default PublicInformationSecurity;
