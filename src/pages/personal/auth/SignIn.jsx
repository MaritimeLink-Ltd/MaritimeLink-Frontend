        ...
        <div className="max-w-md w-full mx-auto lg:mx-0">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="email"
                  required
                  className="block w-full pl-10 pr-3 py-3 sm:py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#003971] focus:border-[#003971] text-sm min-h-[44px]"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="block w-full pl-10 pr-10 py-3 sm:py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#003971] focus:border-[#003971] text-sm min-h-[44px]"
            ...
            <div className="text-right">
              <Link to="/forgot-password" className="text-sm text-[#003971] hover:underline">
                Forgot Password?
              </Link>
            </div>
          ...
          <p className="mt-8 text-sm text-gray-600">
            ...
            <Link to="/signup" className="text-[#003971] font-medium hover:underline">
              Create Your Account
            </Link>
          </p>
        </div>
