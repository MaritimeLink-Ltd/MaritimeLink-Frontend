...
import ProfessionalLicensesCertificates from './dashboard-sections/ProfessionalLicensesCertificates';
...
const CateringMedicalDashboard = () => {
  ...
  const sections = [
    ...
    { id: 4, title: 'Professional Licenses & Certificates' },
  ...
  const completionPercent = useMemo(
    () => calculateResumeCompletion(allData, 'catering'),
    [allData],
  );
  ...
  const handleNext = async (sectionData) => {
    ...
    if (activeSection === 4) {
      ...
      dataToStore = {
        ...
        certificates: markPersisted(mergedCertificates),
      };
    }
      ...
      case 4:
        return (
          <ProfessionalLicensesCertificates
            ...
            isLoading={isLoading}
            apiError={apiError}
            onLocalChange={handleLocalChange('professionalLicensesCertificates')}
          />
        );
      case 5:
        return (
  ...
  const getSectionTitle = () => {
    const titles = {
      ...
      3: 'Key Skills',
      4: 'Professional Licenses & Certificates',
      5: 'Sea Service Log',
  ...
  const getSectionDescription = () => {
    const descriptions = {
      ...
      3: 'Add your skills',
      4: 'Add your professional licenses and certificates',
...
export default CateringMedicalDashboard;
