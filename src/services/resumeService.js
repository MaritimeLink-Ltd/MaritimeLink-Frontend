...
class ResumeService {
    ...
    async getResume() {
        try {
            ...
            return response.data; // directly return the resume data payload
        } catch (error) {
    ...
    /**
     * Step 6 - Update Personal Information in Resume
    ...
    async addMedicalTravelDocument(data) {
        try {
            const payload = {
                ...
                issuingCountry: data.issuingCountry,
                city: data.city || null,
                institutionCountry: data.institutionCountry || null,
                issueDate: data.dateOfIssue || null,
                expiryDate: data.validTill || null,
