...
const title = headerLines[0] || 'MaritimeLink Cookie Policy';
...
const output = `// Auto-generated from filee.txt — do not edit manually; re-run scripts/generate-cookie-copy.mjs
export const COOKIE_TITLE = ${JSON.stringify(title)};

export const COOKIE_META = ${JSON.stringify(meta, null, 4)};

export const COOKIE_SECTIONS = ${JSON.stringify(sections, null, 4)};
`;

fs.writeFileSync(path.join(root, 'src/content/cookieCopy.js'), output, 'utf8');
