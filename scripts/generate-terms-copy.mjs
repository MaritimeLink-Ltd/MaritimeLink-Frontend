...
const title = headerLines[0] || 'MaritimeLink Terms & Conditions';
...
const output = `// Auto-generated from filee.txt — do not edit manually; re-run scripts/generate-terms-copy.mjs
export const TERMS_TITLE = ${JSON.stringify(title)};

export const TERMS_META = ${JSON.stringify(meta, null, 4)};

export const TERMS_SECTIONS = ${JSON.stringify(sections, null, 4)};
`;

fs.writeFileSync(path.join(root, 'src/content/termsCopy.js'), output, 'utf8');
